...
交付路径说明：报告中的 build/job 与 /tmp 路径是独立测试的历史目录。当前目录的 scene.resolved.json 与 assets/ 可直接复建；完整失败和诊断证据位于 [GitHub 测试记录](https://github.com/asimfish/super_img2ppt/tree/main/docs/evidence/embodied_figures/rt2)。
